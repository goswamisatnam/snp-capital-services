    ...
    <section className="py-20 px-[5vw] bg-white">
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <Link href={`/blog/${featured.slug}`}
          className="lg:col-span-3 border border-cream-300 rounded-xl overflow-hidden hover:shadow-card transition-all group">
        ...
        {/* Side list */}
        <div className="lg:col-span-2 flex flex-col divide-y divide-cream-300">
          {rest.map((article, i) => (
            <Link key={article.id} href={`/blog/${article.slug}`}
              className="flex gap-4 py-4 group first:pt-0">
